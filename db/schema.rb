...
ActiveRecord::Schema.define(version: 20141002165924) do
  ...
  add_index "beverages", ["user_id"], name: "index_beverages_on_user_id", using: :btree
  ...
  add_index "trinkets", ["user_id"], name: "index_trinkets_on_user_id", using: :btree
